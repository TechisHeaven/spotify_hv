...
const Login: React.FC = () => {
  ...
  useEffect(() => {
    // Configure the auth URL in the environment
    // if (import.meta.env.VITE_AUTH_URL === undefined) {
    //   window.env = {
    //     ...window.env,
    //     VITE_AUTH_URL: getAuthUrl(),
    //   };
    // }
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-gray-900 rounded-lg shadow-xl overflow-hidden">
        <div className="p-10">
          ...
          <p className="text-gray-500 text-center text-xs mt-8">
            This app requires a Spotify account.
            <br />
